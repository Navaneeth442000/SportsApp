...
class _ScreenAdminState extends State<ScreenAdmin> {
  ...
  //   if(msg == '') {
  //     setData();
  //     Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (ctx) => ScreenAdminViewSelection()));
  //   };
  ...
  Future<void> checkLogin(BuildContext ctx) async {
    ...
    if (_username == 'admin' && _password == 'admin') {
      ...
      Navigator.of(context)
          .pushReplacement(MaterialPageRoute(builder: (ctx) => ScreenAdminViewSelection()));
    } else {
      print('Invalid');
    }
  }
